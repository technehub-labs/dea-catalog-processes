...
| [CR-BP-26](change-requests/CR-BP-26.md) | First Release Cut (v0.1.0) | **Proposed (this PR)** | Converts the CHANGELOG to a `v0.1.0` snapshot, authors `CITATION.cff`, transitions `docs/versioning.md` to post-release. Tag + GitHub release are post-merge on `main`. |
