...
| [CR-BP-15](change-requests/CR-BP-15-process-catalog-reconciliation.md) | Process Catalog Reconciliation | **Implemented** (CR-BP-15-IMP PRs #31-#38; Phase 20 governance approval pending) | Reconciles all existing canonical records against the CR-BP-14 contract; one primary disposition per record (RETAIN / RENAME / RECLASSIFY / RECONTEXTUALIZE / RESPECIALIZE / MERGE / SPLIT / MOVE / DEFER / RETIRE) with full provenance. Reconciliation register + matrix + BP-REC-001..015 gate + repository status model + standard admission gate. |
