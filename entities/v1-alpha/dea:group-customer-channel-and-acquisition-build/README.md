# Canonical Process Group: `dea:group-customer-channel-and-acquisition-build`

This directory hosts the canonical Process Group record
for `dea:group-customer-channel-and-acquisition-build`. The Process Group is a catalog-owned
